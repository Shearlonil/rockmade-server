...
db.gameHoleRecords = require('../entities/game-hole-records')(sequelize, Sequelize, db.games);
db.userHoleContestScores = require('../entities/user-hole-contest-scores')(sequelize, Sequelize, db.gameHoleRecords, db.contests, db.users);
db.gameHoleContests = require('../entities/game-hole-contest')(sequelize, Sequelize);
db.holeScores = require('../entities/user-hole-scores')(sequelize, Sequelize, db.gameHoleRecords, db.users);
